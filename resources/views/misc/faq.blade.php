    ...
    <div id="container">
        ...
        <div class="section wrap faq">
            <div class="page-heading">
                ...
                <div class="page-desc">Have a question about DashAll? Perhaps we already have it answered below.</div>
            </div>
            <div class="qa-block">
            ...
            <div class="qa-block">
                ...
                <p>DashAll is closed currently indefinitely until further notice.</p>
