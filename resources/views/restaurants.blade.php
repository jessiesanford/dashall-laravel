    ...
    <div id="container">
        <div class="wrap">
            ...
            <div class="section">
                ...
                <p>If you own a restaurant, delivery can be a hassle. DashAll makes it easy. Setup your restaurant, assign your drivers, and let us serve you so you can serve your customers!</p>
                ...
                {{--<div class="row push-bottom">--}}
                    {{--<div class="cell">--}}
                        {{--<a href="./restaurants?id=sushi-island"><img src="./img/sushi_island.jpg" alt="Sushi Island" /></a>--}}
                    {{--</div>--}}
                {{--</div>--}}
