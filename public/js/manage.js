$(document).ready(function() {
	...
	$(document).on('click', ".init-update-order-status", function (e)
	{
		...
		content += '<button data-order_id="' + order_id + '" class="update-order-status button_large block width_full push-bottom-20" id="APP_S1">Approved</button>';
		content += '<button data-order_id="' + order_id + '" class="update-order-status button_large block width_full push-bottom-20" id="DEN">Denied</button>';
		content += '<button data-order_id="' + order_id + '" class="mark-complete button_large block width_full">Complete</button>';
